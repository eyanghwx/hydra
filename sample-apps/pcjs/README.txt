...
How to create a Slider app package for pcjs

Create a zip package at the root of the package (<slider enlistment>/pcjs/)
  zip -r pcjs-1.0.0.zip .

Verify the content using  
  unzip -l "$@" pcjs-1.0.0.zip
