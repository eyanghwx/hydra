...
How to create a Slider app package for openai-gym

Create a zip package at the root of the package (<slider enlistment>/openai-gym/)
  zip -r openai-gym-1.0.0.zip .

Verify the content using  
  unzip -l "$@" openai-gym-1.0.0.zip
